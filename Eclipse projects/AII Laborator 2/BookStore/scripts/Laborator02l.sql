...
CREATE TABLE IF NOT EXISTS book (
	...
	FOREIGN KEY (publishing_house_id) REFERENCES publishing_house(id) ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS supply_order (
	...
	FOREIGN KEY (publishing_house_id) REFERENCES publishing_house(id) ON UPDATE CASCADE ON DELETE SET NULL
);
...
CREATE TABLE IF NOT EXISTS supply_order_detail (
	...
	FOREIGN KEY (supply_order_id) REFERENCES supply_order(id) ON UPDATE CASCADE,
	FOREIGN KEY (book_id) REFERENCES book(id) ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS invoice (
	...
	FOREIGN KEY (user_personal_identifier) REFERENCES user(personal_identifier) ON UPDATE CASCADE
);
